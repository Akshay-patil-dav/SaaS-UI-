            ...
            <li className=' text-bl mt-2 fx' >
              <div>
                <div href='' className='fx project a' id="" >
                  <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" className="bi bi-journal-bookmark-fill" viewBox="0 0 16 16">
            ...
            <li className=' text-bl mt-2 fx' >
              <div>
                <div href='' className='fx Customer a' id="" >
                  <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" className="bi mt- bi-people-fill" viewBox="0 0 16 16">
